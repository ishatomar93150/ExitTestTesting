...
public interface XpathResources {
    ...
    String cartIconXPath = "//a[contains(@href, 'cart')]/span";
 // XPath for product details
    String productTitle = "//h1[@class='product-title']";
    String productPrice = "//div[@class='price']";
    String addToCartButton = "//button[contains(text(),'Add to Cart')]";
